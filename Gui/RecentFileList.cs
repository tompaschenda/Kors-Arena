...
{
    /// <summary>
    /// from http://www.codeproject.com/KB/WPF/RecentFileList.aspx
    /// </summary>
	public class RecentFileList : Separator
	{
		...
		{
			Persister = new ConfigurationManagerPersister();
        ...
        private class ConfigurationManagerPersister : IPersist
        {
            public ConfigurationManagerPersister()
            {
            }

            public List<string> RecentFiles(int max)
            {
                return Settings.GetAllMRUs();
            }
            ...
            public void InsertFile(string filepath, int max)
            {
                ...
                Settings.AddMRU(filepath);
            }

            public void RemoveFile(string filepath, int max)
            {
                Settings.RemoveMRU(filepath);
            }
        }
	}
}
